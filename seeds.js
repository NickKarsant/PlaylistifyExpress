...
var artists = [
  {
    ...
    songs: [
      { _id: "1", name: "Koto", artist: "Clozee", liked: false, length: "3:42" },
      { _id: "2", name: "Secret Place", artist: "Clozee", liked: false, length: "4:32" },
      {
        _id: "3", name: "Majesty Clozee remix",
        artist: "Waisu, Apashe, Clozee",
        liked: false, length: "3:12"
      },
      { _id: "4", name: "Baiana Clozee remix", artist: "Bakermat, Clozee", liked: false, length: "4:30" },
      { _id: "5", name: "Evasion", artist: "Clozee", liked: false, length: "2:20" },
      { _id: "6", name: "Aurora", artist: "Clozee", liked: false, length: "3:30" },
      { _id: "7", name: "Blank Panther", artist: "Clozee", liked: false, length: "3:10" },
      {
        _id: "8", name: "Blank Panther David Starfire Remix",
        artist: "Clozee, David Starfire",
        liked: false, length: "4:00"
      },
      {
        _id: "9", name: "Blank Panther PATH remix",
        artist: "Clozee, PATH",
        liked: false, length: "4:10"
      },
      { _id: "10", name: "Varshaver", artist: "Balkan Bump, Clozee", liked: false, length: "3:32" }
    ]
  },
  {
    name: "Good Lee",
    ...
    songs: [{ _id: "11",name: "Kintsugi", artist: "Good Lee", liked: false, length: "3:00" }]
  },
  {
    name: "Shahmen",
